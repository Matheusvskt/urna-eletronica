let rVotoPara = document.querySelector('.esquerda .rotulo.r1 span')
let rCargo = document.querySelector('.esquerda .rotulo.r2 span')
let numeros = document.querySelector('.esquerda .rotulo.r3')
let rDescricao = document.querySelector('.esquerda .rotulo.r4')
let rMensagem = document.querySelector('.esquerda .rotulo.r4 .mensagem')
let rNomeCandidato = document.querySelector('.esquerda .rotulo.r4 .nome-candidato')
let rPartidoPolitico = document.querySelector('.esquerda .rotulo.r4 .partido-politico')
let rNomeVice = document.querySelector('.esquerda .rotulo.r4 .nome-vice')
let rRodape = document.querySelector('.tela .rodape')

let rCandidato = document.querySelector('.direita .candidato')
let rVice = document.querySelector('.direita .candidato.menor')
